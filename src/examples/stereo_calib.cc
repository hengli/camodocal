...
int main(int argc, char** argv)
{
    ...
    camodocal::StereoCameraCalibration calibration(modelType, cameraNameL, cameraNameR, frameSize);
    ...
    if (viewResults)
    {
        ...
        calibration.drawResults(boardSize, squareSize, cbImagesL, cbImagesR);
