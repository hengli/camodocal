...
{
public:
    CameraReprojectionError(const CataCamera::Parameters& intrinsicParams,
...
{
public:
    OdometerCameraReprojectionError(const CataCamera::Parameters& intrinsicParams,
...
{
public:
    OdometerReprojectionError(const CataCamera::Parameters& intrinsicParams,
                              double observed_x, double observed_y,
